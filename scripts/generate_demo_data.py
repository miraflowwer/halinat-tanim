...
def _profile_context() -> dict[str, tuple[str, str, str, str, str, str]]:
    context = {
    ...
    context.update({
        "arrowroot": ("Arrowroot is grown for its edible, starch-rich rhizomes.", "Ang araro ay itinatanim para sa ugat na may almirol.", "Warm, moist conditions help arrowroot form rhizomes.", "Ang init at sapat na tubig ay tumutulong sa paglaki ng araro.", "Use loose soil that drains after heavy rain.", "Gumamit ng maluwag na lupang may maayos na paagusan."),
        "atis": ("Sugar apple is a small tree with sweet, segmented fruit.", "Ang atis ay maliit na punong may matamis na bunga.", "Warm sun and a dry interval can help the tree flower.", "Ang araw at panahong hindi palaging maulan ay makakatulong sa pamumulaklak.", "Give roots well-drained soil and room to spread.", "Bigyan ng lupang maayos ang paagusan at espasyo ang mga ugat."),
        "bamboo_shoots": ("Bamboo shoots are the young edible stems of bamboo.", "Ang labong ay murang tangkay ng kawayan na kinakain.", "Bamboo clumps need warm conditions and moisture for new shoots.", "Kailangan ng init at sapat na tubig ng kawayan para sa bagong labong.", "Keep the clump in soil that drains and has space for new stems.", "Ilagay ang kawayan sa lupang umaagos ang tubig at may espasyo."),
        "banana_blossom": ("Banana blossom is the edible flower bud of a banana plant.", "Ang puso ng saging ay bulaklak ng halamang saging na kinakain.", "Warm, humid conditions and regular water support banana plants.", "Ang init at regular na tubig ay tumutulong sa paglaki ng saging.", "Use fertile soil with drainage around the banana clump.", "Gumamit ng matabang lupang may paagusan sa paligid ng puno."),
        "bottle_gourd": ("Bottle gourd is a vine grown for its young edible fruit.", "Ang upo ay baging na itinatanim para sa murang bunga.", "Warm sun, water, and a trellis help the vine fruit.", "Ang init, tubig, at balag ay tumutulong sa pamumunga ng upo.", "Use loose, fertile soil that does not stay flooded.", "Gumamit ng maluwag at matabang lupang hindi binabaha."),
        "camansi": ("Breadnut is a tree grown for its seeded fruit.", "Ang camansi ay punong itinatanim para sa bungang may buto.", "Warm, humid conditions support the tree's growth.", "Ang mainit at mahalumigmig na lugar ay angkop sa puno.", "Give the tree deep soil with drainage and room for roots.", "Bigyan ang puno ng malalim na lupang may paagusan at espasyo."),
        "camote_tops": ("Sweet potato tops are the edible young leaves and shoots.", "Ang talbos ng kamote ay murang dahon at tangkay na kinakain.", "Warm weather and regular picking support new leafy growth.", "Ang init at regular na pagkuha ng talbos ay tumutulong sa bagong dahon.", "Use loose soil with drainage for the spreading vines.", "Gumamit ng maluwag na lupang may paagusan para sa baging."),
        "celery": ("Celery is grown for its crisp stalks and leaves.", "Ang kintsay ay itinatanim para sa tangkay at dahon.", "Mild weather and even moisture help the stalks grow.", "Ang banayad na panahon at pantay na tubig ay angkop sa kintsay.", "Use fertile soil that stays moist but drains excess water.", "Gumamit ng matabang lupang mamasa-masa pero may paagusan."),
        "chayote": ("Chayote is a climbing vine with edible green fruit.", "Ang sayote ay baging na may berdeng bungang kinakain.", "Mild to warm weather, water, and strong support suit the vine.", "Ang banayad hanggang mainit na panahon at matibay na balag ay angkop dito.", "Give roots fertile soil with drainage and room to spread.", "Bigyan ng matabang lupang may paagusan at espasyo ang ugat."),
        "chico": ("Sapodilla is a fruit tree with sweet brown fruit.", "Ang chico ay punong may matamis at kayumangging bunga.", "Warm sun and moderate water support tree growth.", "Ang araw at katamtamang tubig ay tumutulong sa paglaki ng chico.", "Use deep soil that drains well around the tree.", "Gumamit ng malalim na lupang may maayos na paagusan."),
        "chili_leaves": ("Chili leaves are the edible young leaves of a pepper plant.", "Ang dahon ng sili ay murang dahon ng halamang sili na kinakain.", "Warm sun and regular light watering support new leaves.", "Ang init at banayad na regular na dilig ay angkop sa dahon ng sili.", "Use fertile soil that drains so pepper roots do not stay wet.", "Gumamit ng matabang lupang may paagusan para sa ugat ng sili."),
        "chinese_cabbage": ("Chinese cabbage forms a tall, pale leafy head.", "Ang repolyong Tsino ay bumubuo ng pahabang kumpol ng dahon.", "Cool to mild weather and even water help heads form.", "Ang malamig hanggang banayad na panahon at pantay na tubig ay angkop dito.", "Use fertile soil with organic matter and good drainage.", "Gumamit ng matabang lupang may organikong bagay at paagusan."),
        "cowpea": ("Cowpea is a legume grown for edible beans and pods.", "Ang cowpea ay legume na may nakakain na butil at pod.", "Warm weather and moderate water support the plants.", "Ang init at katamtamang tubig ay angkop sa cowpea.", "Use well-drained soil and avoid standing water around roots.", "Gumamit ng lupang may paagusan at iwasan ang nakatigil na tubig."),
        "dragon_fruit": ("Dragon fruit comes from a climbing cactus with large fruit.", "Ang dragon fruit ay bunga ng gumagapang na cactus.", "Warm sun and support for stems help this cactus grow.", "Ang init, araw, at suporta sa tangkay ay tumutulong sa paglaki nito.", "Use well-drained soil and keep roots from standing water.", "Gumamit ng lupang may paagusan at iwasan ang naiipong tubig."),
        "duhat": ("Java plum is a tree with small, dark fruit.", "Ang duhat ay punong may maliit at maitim na bunga.", "Warm sun and seasonal rain support tree growth.", "Ang init, araw, at pana-panahong ulan ay angkop sa duhat.", "Give the tree deep soil with space for its roots.", "Bigyan ang puno ng malalim na lupa at espasyo para sa ugat."),
        "green_papaya": ("Green papaya is papaya picked before it ripens.", "Ang papayang hilaw ay bunga ng papaya na inani bago mahinog.", "Warm sun and steady moisture support papaya fruit growth.", "Ang init, araw, at regular na tubig ay tumutulong sa paglaki ng papaya.", "Use deep, well-drained soil around the papaya stem.", "Gumamit ng malalim na lupang may paagusan sa paligid ng puno."),
        "habichuelas": ("Baguio beans are tender green pods of a bean plant.", "Ang habitchuelas ay murang berdeng pod ng halamang bean.", "Mild weather, regular water, and support help pods form.", "Ang banayad na panahon, tubig, at suporta ay tumutulong sa pod.", "Use fertile soil with drainage around the bean roots.", "Gumamit ng matabang lupang may paagusan para sa ugat."),
        "jackfruit": ("Jackfruit is a tree with large fruit eaten ripe.", "Ang langka ay punong may malaking bungang kinakain kapag hinog.", "Warm, humid weather supports tree and fruit growth.", "Ang mainit at mahalumigmig na panahon ay angkop sa langka.", "Use deep soil with drainage and space for a large tree.", "Gumamit ng malalim na lupang may paagusan at sapat na espasyo."),
        "jackfruit_young": ("Young jackfruit is harvested before the fruit ripens.", "Ang batang langka ay inaani bago mahinog ang bunga.", "Warm, humid weather supports the jackfruit tree.", "Ang mainit at mahalumigmig na panahon ay angkop sa puno ng langka.", "Give the tree deep soil with drainage and room for roots.", "Bigyan ang puno ng malalim na lupang may paagusan at espasyo."),
        "jicama": ("Jicama is grown for its crisp edible storage root.", "Ang singkamas ay itinatanim para sa malutong na ugat.", "Warm weather and moderate water help the root enlarge.", "Ang init at katamtamang tubig ay tumutulong sa paglaki ng ugat.", "Use deep, loose soil with good drainage.", "Gumamit ng malalim at maluwag na lupang may paagusan."),
    })
    context.update({
        "kamias": ("Bilimbi is a small tree with sour green fruit.", "Ang kamias ay maliit na punong may maasim na berdeng bunga.", "Warm sun and regular rain support the tree.", "Ang init, araw, at regular na ulan ay angkop sa kamias.", "Use fertile soil with drainage around the roots.", "Gumamit ng matabang lupang may paagusan sa paligid ng ugat."),
        "kangkong": ("Kangkong is a leafy vegetable with tender stems.", "Ang kangkong ay gulay na may malambot na dahon at tangkay.", "Warm weather and frequent water help leaves and stems grow.", "Ang init at madalas na tubig ay tumutulong sa paglaki nito.", "Keep soil moist and check drainage for the chosen growing method.", "Panatilihing mamasa-masa ang lupa at suriin ang paagusan."),
        "kidney_bean": ("Kidney bean is a legume grown for its edible dry beans.", "Ang kidney bean ay legume na itinatanim para sa tuyong butil.", "Mild weather and moderate water support pod growth.", "Ang banayad na panahon at katamtamang tubig ay angkop dito.", "Use loose soil with drainage around the roots.", "Gumamit ng maluwag na lupang may paagusan sa paligid ng ugat."),
        "lanzones": ("Lanzones is a tree that bears clusters of small fruit.", "Ang lanzones ay punong namumunga ng kumpol ng maliliit na prutas.", "Warm, humid conditions support the tree.", "Ang mainit at mahalumigmig na lugar ay angkop sa lanzones.", "Use deep soil that holds some moisture but drains excess water.", "Gumamit ng malalim na lupang may tubig pero may paagusan."),
        "lemon": ("Lemon is a citrus tree with sour yellow fruit.", "Ang limon ay punong citrus na may maasim na dilaw na bunga.", "Sun and regular water support flowering and fruiting.", "Ang araw at regular na tubig ay tumutulong sa pamumulaklak at bunga.", "Use well-drained soil and avoid standing water at the trunk.", "Gumamit ng lupang may paagusan at iwasan ang tubig sa puno."),
        "lepote": ("Lepote is a locally named fruit crop in the Quezon crop report.", "Ang lepote ay prutas na nakatala sa ulat ng pananim sa Quezon.", "Check local planting guidance for the specific lepote variety.", "Suriin ang lokal na gabay para sa uri ng lepote bago magtanim.", "Check local soil and drainage needs with an agriculture worker.", "Itanong sa kawani ng agrikultura ang angkop na lupa at paagusan."),
        "lima_bean": ("Lima bean is a legume grown for its broad edible beans.", "Ang patani ay legume na may malapad na butil na kinakain.", "Warm weather and moderate water support the vines.", "Ang init at katamtamang tubig ay tumutulong sa baging ng patani.", "Use fertile soil with drainage and support climbing types.", "Gumamit ng matabang lupang may paagusan at suporta sa baging."),
        "malunggay_leaves": ("Moringa leaves are picked from a fast-growing tree.", "Ang dahon ng malunggay ay kinukuha sa mabilis lumaking puno.", "Warm sun and regular pruning support new leaves.", "Ang araw at regular na pagputol ay tumutulong sa bagong dahon.", "Use soil with drainage around the tree roots.", "Gumamit ng lupang may paagusan sa paligid ng ugat ng puno."),
        "mandarin": ("Mandarin is a citrus tree with small, easy-peel fruit.", "Ang dalanghita ay punong citrus na may maliit na bungang madaling balatan.", "Sun and regular water support flowers and fruit.", "Ang araw at regular na tubig ay tumutulong sa bulaklak at bunga.", "Use well-drained soil and leave room around the tree.", "Gumamit ng lupang may paagusan at maglaan ng espasyo sa puno."),
        "mangosteen": ("Mangosteen is a tropical tree with dark purple fruit.", "Ang mangostan ay punong tropikal na may maitim na lilang bunga.", "Warm, humid weather and steady moisture suit the tree.", "Ang init at tuloy-tuloy na tubig ay angkop sa puno.", "Use deep soil that holds moisture without long flooding.", "Gumamit ng malalim na lupang mamasa-masa pero hindi binabaha."),
        "melon": ("Melon is a vine grown for its sweet fruit.", "Ang melon ay baging na itinatanim para sa matamis na bunga.", "Warm sun, open space, and even water support fruit growth.", "Ang init, araw, espasyo, at pantay na tubig ay angkop sa melon.", "Use sandy loam with drainage around the vines.", "Gumamit ng sandy loam na may paagusan sa paligid ng baging."),
        "mustard_greens": ("Mustard greens are leafy vegetables with a sharp taste.", "Ang mustasa ay madahong gulay na may matapang na lasa.", "Mild weather and regular water help tender leaves grow.", "Ang banayad na panahon at regular na tubig ay angkop sa dahon.", "Use fertile soil with drainage and organic matter.", "Gumamit ng matabang lupang may paagusan at organikong bagay."),
        "orange": ("Orange is a citrus tree grown for sweet fruit.", "Ang kahel ay punong citrus na itinatanim para sa matamis na bunga.", "Sun and steady moisture support flowering and fruiting.", "Ang araw at regular na tubig ay tumutulong sa bulaklak at bunga.", "Use well-drained soil and avoid water around the trunk.", "Gumamit ng lupang may paagusan at iwasan ang tubig sa puno."),
        "oregano": ("Oregano is an herb grown for its scented leaves.", "Ang oregano ay halamang itinatanim para sa mabangong dahon.", "Sun and light watering support leafy growth.", "Ang araw at banayad na dilig ay tumutulong sa paglaki ng dahon.", "Use loose soil that drains well between watering.", "Gumamit ng maluwag na lupang umaagos ang tubig."),
        "paco": ("Edible fern is harvested for its tender young fronds.", "Ang paco ay inaani para sa malambot na bagong dahon.", "Moist, shaded places support fern growth.", "Ang mamasa-masa at malilim na lugar ay angkop sa paco.", "Use soil that stays moist without stagnant water.", "Gumamit ng lupang mamasa-masa pero walang nakatigil na tubig."),
        "pao_galiang": ("Pao or galiang is a locally named root crop in the Quezon report.", "Ang galiang ay lokal na pangalang ugat na pananim sa ulat ng Quezon.", "Confirm the local crop identity before choosing planting conditions.", "Tiyakin muna ang uri ng galiang bago pumili ng paraan ng pagtatanim.", "Ask a local agriculture worker about soil and drainage needs.", "Itanong sa kawani ng agrikultura ang angkop na lupa at paagusan."),
        "passion_fruit": ("Passion fruit is a climbing vine with fragrant fruit.", "Ang passion fruit ay baging na may mabangong bunga.", "Warm sun, water, and a firm trellis support fruiting.", "Ang init, tubig, at matibay na balag ay tumutulong sa pamumunga.", "Use fertile soil with drainage around the vine roots.", "Gumamit ng matabang lupang may paagusan sa paligid ng ugat."),
        "patola": ("Ridge gourd is a vine grown for tender ridged fruit.", "Ang patola ay baging na may murang bungang may guhit.", "Warm sun, water, and a trellis help the vine fruit.", "Ang init, tubig, at balag ay tumutulong sa pamumunga ng patola.", "Use loose, fertile soil with good drainage.", "Gumamit ng maluwag at matabang lupang may paagusan."),
        "pigeon_pea": ("Pigeon pea is a shrub legume grown for edible peas.", "Ang kadios ay palumpong na legume na may nakakain na butil.", "Warm weather and moderate water support pod formation.", "Ang init at katamtamang tubig ay tumutulong sa pagbuo ng pod.", "Use well-drained soil and avoid long flooding.", "Gumamit ng lupang may paagusan at iwasan ang matagal na baha."),
        "pili_nut": ("Pili is a tree grown for edible nuts inside its fruit.", "Ang pili ay punong itinatanim para sa nakakain na buto ng bunga.", "Warm, humid weather supports a mature pili tree.", "Ang mainit at mahalumigmig na panahon ay angkop sa puno ng pili.", "Give the tree deep soil with drainage and root space.", "Bigyan ang puno ng malalim na lupang may paagusan at espasyo."),
        "pomelo": ("Pomelo is a citrus tree with large, thick-skinned fruit.", "Ang suha ay punong citrus na may malaking bungang makapal ang balat.", "Sun and regular water support fruit growth.", "Ang araw at regular na tubig ay tumutulong sa paglaki ng bunga.", "Use deep, well-drained soil around the tree.", "Gumamit ng malalim na lupang may maayos na paagusan."),
        "radish": ("Radish is grown for its crisp edible root.", "Ang labanos ay itinatanim para sa malutong na ugat.", "Mild weather and even water help roots form.", "Ang banayad na panahon at pantay na tubig ay tumutulong sa ugat.", "Use loose, stone-free soil so roots grow straight.", "Gumamit ng maluwag at walang batong lupa para sa ugat."),
        "rambutan": ("Rambutan is a tree with red, hairy-skinned fruit.", "Ang rambutan ay punong may pulang bungang mabalahibo ang balat.", "Warm, humid weather and water support the tree.", "Ang init at regular na tubig ay angkop sa rambutan.", "Use deep soil that drains after heavy rain.", "Gumamit ng malalim na lupang may paagusan matapos ang ulan."),
        "santol": ("Santol is a tree with round fruit and thick rind.", "Ang santol ay punong may bilog na bungang makapal ang balat.", "Warm sun and seasonal rain support tree growth.", "Ang init, araw, at pana-panahong ulan ay angkop sa santol.", "Give the tree deep soil and space for roots.", "Bigyan ang puno ng malalim na lupa at espasyo para sa ugat."),
        "sineguelas": ("Sineguelas is a small tree with oval fruit eaten ripe.", "Ang sineguelas ay maliit na punong may pahabang bungang kinakain.", "Warm sun and a drier season can support flowering.", "Ang araw at mas tuyong panahon ay makakatulong sa pamumulaklak.", "Use soil with drainage and room for tree roots.", "Gumamit ng lupang may paagusan at espasyo para sa ugat."),
        "soursop": ("Soursop is a tree with large, soft, green fruit.", "Ang guyabano ay punong may malaking malambot na berdeng bunga.", "Warm weather and regular water support the tree.", "Ang init at regular na tubig ay angkop sa guyabano.", "Use deep soil with drainage around the trunk.", "Gumamit ng malalim na lupang may paagusan sa paligid ng puno."),
        "squash_tops": ("Squash tops are the edible young leaves and shoots of squash.", "Ang talbos ng kalabasa ay murang dahon at tangkay na kinakain.", "Warm sun and regular picking support new shoots.", "Ang init at regular na pagkuha ng talbos ay tumutulong sa bagong dahon.", "Use fertile soil with drainage and room for spreading vines.", "Gumamit ng matabang lupang may paagusan at espasyo sa baging."),
        "star_apple": ("Star apple is a tree with round fruit and milky flesh.", "Ang kaimito ay punong may bilog na bungang may maputing laman.", "Warm sun and seasonal rain support tree growth.", "Ang init, araw, at pana-panahong ulan ay angkop sa kaimito.", "Use deep soil with drainage and space around the tree.", "Gumamit ng malalim na lupang may paagusan at espasyo."),
        "strawberry": ("Strawberry is a low plant grown for its soft red fruit.", "Ang istraberi ay mababang halamang may malambot na pulang bunga.", "Mild conditions, sun, and even moisture support fruiting.", "Ang banayad na panahon, araw, at pantay na tubig ay angkop dito.", "Use loose soil with drainage and keep fruit off wet ground.", "Gumamit ng maluwag na lupang may paagusan at iwasang mabasa ang bunga."),
        "sweet_peas": ("Sweet peas are grown for tender edible pea pods.", "Ang sitsaro ay itinatanim para sa murang pod na kinakain.", "Mild weather, even water, and support help pods form.", "Ang banayad na panahon, tubig, at suporta ay tumutulong sa pod.", "Use fertile, well-drained soil for the pea roots.", "Gumamit ng matabang lupang may paagusan para sa ugat."),
        "tamarind": ("Tamarind is a tree with sour pulp inside brown pods.", "Ang sampalok ay punong may maasim na laman sa kayumangging pod.", "Warm sun and seasonal rain support the mature tree.", "Ang init, araw, at pana-panahong ulan ay angkop sa puno.", "Use deep soil with drainage and room for roots.", "Gumamit ng malalim na lupang may paagusan at espasyo sa ugat."),
        "taro_leaves": ("Taro leaves with stems are harvested from the gabi plant.", "Ang dahon at tangkay ng gabi ay inaani mula sa halamang gabi.", "Warm, moist conditions support leaf growth.", "Ang init at mamasa-masang lugar ay angkop sa dahon ng gabi.", "Use moisture-holding soil without stagnant water.", "Gumamit ng lupang mamasa-masa pero walang nakatigil na tubig."),
        "tugue": ("Tugue is a yam grown for its edible underground tuber.", "Ang tugue ay uri ng yam na may nakakain na tuber sa lupa.", "Warm weather and a long growing season support tubers.", "Ang init at mahabang panahon ay tumutulong sa paglaki ng tuber.", "Use deep, loose soil with drainage for the tubers.", "Gumamit ng malalim at maluwag na lupang may paagusan."),
        "white_potato": ("White potato is grown for edible underground tubers.", "Ang patatas ay itinatanim para sa tuber sa ilalim ng lupa.", "Cool to mild weather and even water support tubers.", "Ang malamig hanggang banayad na panahon at pantay na tubig ay angkop dito.", "Use loose, well-drained soil and cover exposed tubers.", "Gumamit ng maluwag na lupang may paagusan at takpan ang tuber."),
        "winged_bean": ("Winged bean is a vine with edible ridged pods.", "Ang sigarilyas ay baging na may nakakain na pod na may pakpak.", "Warm sun, water, and a trellis support the vine.", "Ang init, tubig, at balag ay tumutulong sa baging.", "Use fertile soil with drainage around the roots.", "Gumamit ng matabang lupang may paagusan sa paligid ng ugat."),
    })
    return context
...
def _profile_rows(crops: list[dict[str, str]], version: str) -> Iterable[dict[str, str]]:
    ...
    missing = {crop["crop_id"] for crop in _active_rows(crops)} - context.keys()
    if missing:
        raise ValueError(f"active crops lack deliberate profile content: {sorted(missing)}")
    for crop in sorted(_active_rows(crops), key=lambda row: row["crop_id"]):
        summary_en, summary_tl, conditions_en, conditions_tl, soil_en, soil_tl = context[
            crop["crop_id"]
        ]
        yield {
