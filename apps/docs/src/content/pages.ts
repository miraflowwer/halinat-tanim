    ...
    "introduction",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          paragraphs: [
            "The TANIM Engine page describes the Phase 3 code in this repository. Other product areas are described only where the repository supports the details. Some guides are short until their product flows are available in this version.",
          ],
        },
      ],
    },
    ...
    "getting-started",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "New users read the Privacy Notice and register as a Farmer or Cooperative user. TANIM then shows a seven-step first-time demo with sample data. The demo does not save a planting plan. Plan creation and management screens are not available yet.",
        },
        {
          kind: "text",
          heading: "Explore the engine example",
          paragraphs: [
            "The Phase 3 engine is an API calculation, not a complete farmer screen. Read How Glut Risk Works and the Engine Example to understand its inputs and result.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Binabasa muna ng mga bagong user ang Privacy Notice at nagrerehistro bilang magsasaka o kooperatiba. Pagkatapos, ipinapakita ng TANIM ang pitong-hakbang na unang demo gamit ang halimbawang datos. Hindi nagse-save ng planong pananim ang demo. Wala pa ang mga screen para gumawa o mamahala ng plano.",
        },
        {
          kind: "text",
          heading: "Tingnan ang halimbawa ng engine",
          paragraphs: [
            "API calculation ang Phase 3 engine, hindi pa kumpletong screen para sa magsasaka. Basahin ang Paano Gumagana ang Glut Risk at Halimbawa ng Engine upang malaman ang mga input at resulta nito.",
          ],
        },
      ],
    },
    ...
    "farmer-guide",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          title: "Current guide status",
          text: "The demo uses sample data and does not save a planting plan. The current platform does not yet provide screens to create, edit, or remove plans. This guide does not cover crop, price, suitability, map, or weather screens yet.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Gumagamit ng halimbawang datos ang demo at hindi ito nagse-save ng planong pananim. Wala pa ang mga screen para gumawa, mag-edit, o mag-alis ng plano. Hindi pa kasama sa gabay na ito ang mga screen para sa crop, presyo, kaangkupan, mapa, at weather.",
        },
      ],
    },
    ...
    "cooperative-guide",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Current guide status",
          text: "A Cooperative user can register and sign in. The platform does not yet provide a cooperative planning screen, so this guide does not describe plan aggregation or what member details a cooperative can see.",
        },
        {
          kind: "list",
          heading: "Topics to check when the cooperative view is available",
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Katayuan ng gabay",
          text: "Maaaring magparehistro at mag-sign in ang mga gumagamit mula sa kooperatiba. Wala pa ang screen para sa pagpaplano ng kooperatiba kaya hindi inilalarawan ng gabay na ito ang pinagsama-samang plano o kung anong detalye ng mga kasapi ang makikita ng kooperatiba.",
        },
        {
          kind: "list",
    ...
    "crop-information",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "The current repository version has the crop registry and demo data, but not a verified Crop Library screen. The final guide will match that screen after it is available.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Nasa kasalukuyang bersyon ng repository ang crop registry at demo data, pero wala pang nasuring Crop Library screen. Itutugma ang huling gabay sa screen kapag available na ito.",
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          paragraphs: [
            "TANIM price records use Philippine pesos per kilogram (PHP/kg) unless a dataset says otherwise. A future Price History view is intended to show records by crop and supported location over time.",
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Screen availability",
          text: "This repository version does not include a verified Price History screen. Its controls and location coverage are not described here.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          paragraphs: [
            "Gumagamit ang mga price record ng TANIM ng Philippine pesos bawat kilo (PHP/kg), maliban kung iba ang nakasaad sa dataset. Layunin ng Price History view na ipakita sa paglipas ng panahon ang mga record ayon sa pananim at sinusuportahang lugar.",
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Availability ng screen",
          text: "Wala pa sa bersyong ito ng repository ang nasuring Price History screen. Hindi inilalarawan dito ang mga control at saklaw ng lokasyon nito.",
        },
      ],
    },
    ...
    "crop-information",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Screen availability",
          text: "The current repository version does not include a verified Soil Suitability screen.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          calloutKind: "limitation",
          title: "Availability ng screen",
          text: "Wala pa sa kasalukuyang bersyon ng repository ang nasuring Soil Suitability screen.",
        },
      ],
    },
    ...
    "maps-weather",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "The map and weather product screens are not included here. Their exact controls and weather provider remain unconfirmed.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Wala rito ang mga screen ng mapa at weather. Hindi pa kumpirmado ang eksaktong mga control at weather provider.",
        },
      ],
    },
    ...
    "maps-weather",
    {
      ...
      blocks: [
        ...
        },
        {
          kind: "callout",
          calloutKind: "limitation",
          title: "Controls are not confirmed",
          text: "The product requirements call for crop, period, and supply-context filters. This repository version does not include the map screen, so this guide does not name controls or describe a completed map interaction.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Nangangailangan ang product requirements ng filter para sa pananim, panahon, at konteksto ng supply. Wala pa sa bersyong ito ng repository ang map screen, kaya hindi pinapangalanan ng gabay na ito ang mga control o inilalarawan ang hindi pa tapos na paggamit ng mapa.",
        },
      ],
    },
    ...
    "maps-weather",
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "The weather feature is not in this repository version. No provider name or user control is confirmed here. These details must be checked against the implemented weather flow.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Wala pa sa bersyong ito ng repository ang weather feature. Walang provider o control ng user na kumpirmado rito. Kailangang suriin ang mga detalyeng ito batay sa nagawang weather flow.",
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Planting plans: user-entered proposed crop, place, area, dates, and status when the plan feature is available.",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Mga planong pananim: pananim, lugar, lawak, petsa, at status na inilalagay ng user kapag available na ang feature ng plano.",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "The current version includes account registration, sign-in, consent, and the first-time demo. Planting-plan creation and management screens are not available yet. Crop, map, and weather screens still need a product check.",
          ],
        },
        {
          kind: "text",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "May registration, sign-in, privacy consent, at unang demo na ang TANIM. Wala pa ang mga screen para gumawa at mamahala ng planting plan. Hindi pa nasusuri ang mga crop, map, at weather screen.",
          ],
        },
        {
          kind: "text",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: "Live weather may need internet and an available service. The weather feature is not in this repository version, so its provider and retry screen are not yet confirmed.",
            },
            {
            ...
            },
            {
              ...
              answer: "The local prototype runs on your computer. Live weather may need internet when that feature is available. The current repository version does not include the weather feature.",
            },
            {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: "Maaaring kailangan ng internet at available na service para sa live weather. Wala pa sa bersyong ito ng repository ang weather feature kaya hindi pa kumpirmado ang provider at retry screen.",
            },
            {
            ...
            },
            {
              ...
              answer: "Gumagana sa computer mo ang lokal na prototype. Maaaring kailangan ng internet ang live weather kapag available na ang feature na iyon. Wala pa sa kasalukuyang bersyon ng repository ang weather feature.",
            },
            {
      ...
      blocks: [
        {
          ...
          paragraphs: [
            ...
            "The app supports sign-in sessions that last seven days. It does not yet provide planting-plan creation or management screens. This page does not describe future plan records.",
          ],
        },
        {
          kind: "list",
        ...
        },
        {
          ...
          text: "This page describes the current account and consent flow. Review it again when planting-plan and weather features are available. It does not promise a data-retention period, a deletion process, or a legal compliance result.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          paragraphs: [
            ...
            "May sign-in session ang app na tumatagal nang pitong araw. Wala pa itong screen para gumawa o mamahala ng planting plan. Hindi inilalarawan dito ang mga tala ng planong gagawin sa hinaharap.",
          ],
        },
        {
          kind: "list",
        ...
        },
        {
          ...
          text: "Inilalarawan ng pahinang ito ang kasalukuyang daloy ng account at consent. Suriin itong muli kapag available na ang mga feature para sa planting plan at weather. Hindi ito nangangako ng panahon ng pag-iingat ng datos, proseso ng pagbura, o resulta tungkol sa pagsunod sa batas.",
        },
      ],
    },
